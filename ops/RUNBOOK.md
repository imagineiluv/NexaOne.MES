...
작성 2026-07-09, 저장소 미러 2026-07-10 — 원본은 옵시디언 볼트(`NexaMes/docs/design/Deployment-Operations.md`)이며
...
- **SPA는 자동 빌드**되어 `wwwroot/spa/`로 포함된다(csproj publish Target — node 필요).
...
4. (모듈 검증) 임의 마스터 화면(`/meta/FACTORY_MDM_PLANT`) 그리드 행 렌더.
