...
| **2** Pro-Code | ✅ 토대 | React+Vite+TS SPA(`src/01.Web/NexaOne.Spa`)+NSwag+permission 가드+토큰갱신. **npm install 검증 완료**(2026-06-15, package-lock.json 고정). 잔여: 생성 클라이언트(`gen:api`)는 실행 중인 API(:5181 swagger.json)가 필요 + Blazor 셸 임베드(제품 결정) |
