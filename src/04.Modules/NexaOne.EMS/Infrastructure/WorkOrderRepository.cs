...
public sealed class WorkOrderRepository : QueryRepository, IWorkOrderRepository
{
    ...
    {
        const string sql = "SELECT * FROM EMS_WORK_ORDER WITH(NOLOCK) WHERE WO_ID = @woId";
    ...
    {
        const string sql = @"SELECT * FROM EMS_WORK_ORDER WITH(NOLOCK)
    ...
    {
        const string sql = "SELECT * FROM EMS_WORK_ORDER WITH(NOLOCK) WHERE STATUS = @status";
    ...
    {
        const string sql = @"UPDATE EMS_WORK_ORDER SET
