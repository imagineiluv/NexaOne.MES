...
public sealed class MaintenancePlanRepository : QueryRepository, IMaintenancePlanRepository
{
    ...
    {
        const string sql = "SELECT * FROM EMS_MAINTENANCE_PLAN WITH(NOLOCK) WHERE PLAN_ID = @planId";
    ...
    {
        const string sql = @"SELECT * FROM EMS_MAINTENANCE_PLAN WITH(NOLOCK)
    ...
    {
        const string sql = "SELECT * FROM EMS_MAINTENANCE_PLAN WITH(NOLOCK) WHERE STATUS = @status ORDER BY SCHEDULED_DATE";
    ...
    {
        const string sql = @"INSERT INTO EMS_MAINTENANCE_PLAN
    ...
    {
        const string sql = @"UPDATE EMS_MAINTENANCE_PLAN SET
