...
/// <summary>
/// Reconciles the SQLite billing schema for invoice-linked credit notes. SQL Server receives the
/// equivalent contract from V189; SQLite requires a table rebuild because it cannot drop the
/// inline kind and status checks installed by V170.
/// </summary>
public sealed class ErpBillingSqliteSchemaContribution : ISqliteSchemaContribution
{
    public string Id => "ERP.Billing.V189";
