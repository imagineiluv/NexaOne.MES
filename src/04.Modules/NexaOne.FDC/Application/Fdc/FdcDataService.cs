...
public sealed class FdcDataService
{
        ...
        string parameterId, string? groupId, CancellationToken ct = default)
    {
        ...
        if (param is null)
            return Result.Failure(Error.NotFoundOf(nameof(FdcParameter), parameterId));
        ...
        CancellationToken ct = default)
    {
        ...
        if (param is null)
            return Result.Failure<FdcCollectData>(Error.NotFoundOf(nameof(FdcParameter), parameterId));
