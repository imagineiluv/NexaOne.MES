...
public interface IDeliveryBridge : INexaModuleBridge
{
    ...
    Task<BusinessPage<DeliveryTemplate>> ListTemplatesAsync(string userId, Guid tenantId, Guid organizationId,
        int offset = 0, int limit = 50, CancellationToken ct = default);
    ...
    Task<DeliveryProfile> DeactivateProfileAsync(string userId, Guid tenantId, Guid organizationId,
        Guid id, Guid version, CancellationToken ct = default);
    Task<BusinessPage<DeliveryProfile>> ListProfilesAsync(string userId, Guid tenantId, Guid organizationId,
        int offset = 0, int limit = 50, CancellationToken ct = default);
    ...
    Task<BusinessPage<DeliveryRequest>> ListRequestsAsync(string userId, Guid tenantId, Guid organizationId,
        int offset = 0, int limit = 50, CancellationToken ct = default);
