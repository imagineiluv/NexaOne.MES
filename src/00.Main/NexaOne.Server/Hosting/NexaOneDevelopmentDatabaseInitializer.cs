...
internal static class NexaOneDevelopmentDatabaseInitializer
{
    ...
    public static void Initialize(WebApplication app)
    {
        ...
        EnsureDevWorkflowResources(connectionString, "V194__CRM_WORKSPACE_MENU.sql");
        EnsureDevWorkflowResources(connectionString, "V195__CRM_DEAL_EDITOR_RESOURCES.sql");
        ...
        EnsureDevWorkflowResources(connectionString, "V206__ERP_EXPENSE_RECEIPT_RESOURCES.sql");
        ...
        EnsureDevWorkflowResources(connectionString, "V217__HR_TIME_REPORT_WORKSPACE.sql");
