...
/// </summary>
public sealed class EstOutboxIntegrationTests : OutboxIntegrationTestBase
{
    ...
    public async Task State_change_writes_outbox_in_same_transaction_when_enabled()
    {
        ...
        OutboxCount(On.ConnectionString, "EQ-OB-ON").Should().Be(1,
    ...
    public async Task State_change_does_not_write_outbox_when_disabled()
    {
        ...
        OutboxCount(Off.ConnectionString, "EQ-OB-OFF").Should().Be(0,
