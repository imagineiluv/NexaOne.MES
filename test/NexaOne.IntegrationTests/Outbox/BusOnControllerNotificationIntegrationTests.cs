...
/// </summary>
public sealed class BusOnControllerNotificationIntegrationTests : OutboxIntegrationTestBase
{
    public BusOnControllerNotificationIntegrationTests(TestApiFactory off, OutboxEnabledTestApiFactory on)
        : base(off, on)
    {
    }
    ...
    {
        var client = On.CreateAuthenticatedClient();   // ADMIN("*") — perm:est:manage 충족
        ...
        OutboxCount(On.ConnectionString, "EQ-BUSON-1", "EquipmentAlarmRaised").Should().Be(1,
