...
/// </summary>
public sealed class CmmsWorkOrderOutboxIntegrationTests : OutboxIntegrationTestBase
{
    ...
    public async Task WorkOrder_start_writes_outbox_in_same_transaction_when_enabled()
    {
        ...
        OutboxCount(On.ConnectionString, "WO-OB-ON", "WorkOrderStarted").Should().Be(1,
    ...
    public async Task WorkOrder_start_does_not_write_outbox_when_disabled()
    {
        ...
        OutboxCount(Off.ConnectionString, "WO-OB-OFF", "WorkOrderStarted").Should().Be(0,
