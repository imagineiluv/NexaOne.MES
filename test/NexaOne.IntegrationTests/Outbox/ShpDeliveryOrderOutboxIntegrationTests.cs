...
/// </summary>
public sealed class ShpDeliveryOrderOutboxIntegrationTests
    : IClassFixture<TestApiFactory>, IClassFixture<OutboxEnabledTestApiFactory>
{
    ...
    public async Task Confirm_writes_outbox_in_same_transaction_when_enabled()
    {
        ...
        OutboxCount(_on.ConnectionString, "DO-OB-CONF", "DeliveryOrderConfirmed").Should().Be(1,
    ...
    public async Task Ship_writes_outbox_in_same_transaction_when_enabled()
    {
        ...
        OutboxCount(_on.ConnectionString, "DO-OB-SHIP", "DeliveryOrderShipped").Should().Be(1,
    ...
    public async Task Cancel_writes_outbox_in_same_transaction_when_enabled()
    {
        ...
        OutboxCount(_on.ConnectionString, "DO-OB-CANC", "DeliveryOrderCancelled").Should().Be(1,
    ...
    public async Task Confirm_does_not_write_outbox_when_disabled()
    {
        ...
        OutboxCount(_off.ConnectionString, "DO-OB-OFF", "DeliveryOrderConfirmed").Should().Be(0,
