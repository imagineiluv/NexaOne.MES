...
/// </summary>
public sealed class PomLotOutboxIntegrationTests : OutboxIntegrationTestBase
{
    ...
    public async Task Lot_trackin_writes_outbox_in_same_transaction_when_enabled()
    {
        ...
        OutboxCount(On.ConnectionString, "LOT-OB-ON", "LotTrackedIn").Should().Be(1,
    ...
    public async Task Lot_trackin_does_not_write_outbox_when_disabled()
    {
        ...
        OutboxCount(Off.ConnectionString, "LOT-OB-OFF", "LotTrackedIn").Should().Be(0,
